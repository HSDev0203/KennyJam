...
pygame.display.set_caption("Power Re-Direct")
...
bg_music = pygame.mixer.Sound('Assets/sfx/Re-Direct BGM.wav')
music_started = False
...
while running:
    ...
    if (not intro) and (not game_over):
        ...
        if not music_started:
            bg_music_channel = bg_music.play(loops=-1)
            bg_music_channel.set_volume(0.65)
            music_started = True
    ...
    # Music
    if game_over and bg_music_channel.get_busy():
